...
#line 10 "..\\..\\..\\..\\Library\\Nu-LB-NUC140\\Include\\I2Cdev.h"
...
#line 7 "..\\..\\..\\..\\Library\\Nu-LB-NUC140\\Source\\I2Cdev.c"
...
void I2C_readBytes(I2C_T *i2c, uint8_t devAddr, uint8_t regAddr, uint8_t length, uint8_t *data) 
{
	uint8_t i, tmp;
	      ...
	      ((i2c)->I2CDAT = (devAddr));         
	      ((i2c)->I2CON = ((i2c)->I2CON & ~0x3c) | (0x08UL));
	      while(!((i2c)->I2CON & (1ul << 3)));
	      ...
	      ((i2c)->I2CON = ((i2c)->I2CON & ~0x3c) | (0x20UL | 0x08UL));	
	      while(!((i2c)->I2CON & (1ul << 3)));

		    ((i2c)->I2CDAT = ((devAddr+1)));    
	      ((i2c)->I2CON = ((i2c)->I2CON & ~0x3c) | (0x08UL));
	      while(!((i2c)->I2CON & (1ul << 3)));							
